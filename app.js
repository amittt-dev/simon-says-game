...
function levelUp(){
    userSeq = [];
    level++;
    h2.innerText = `Level ${level} | High Score: ${highScore}`;  //  Show high score

    let randIdx = Math.floor(Math.random() * btns.length);  //  Fixed random bug
...
function btnPress(){
    ...
    let userColor = btn.getAttribute("id");  //  Added let
